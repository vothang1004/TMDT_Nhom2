package com.tmdt.backend.rest;

import com.tmdt.backend.dto.LoginDTO;
import com.tmdt.backend.dto.SignupDTO;
import com.tmdt.backend.dto.TokenDTO;
import com.tmdt.backend.jwt.JwtHelper;
import com.tmdt.backend.model.RefreshToken;
import com.tmdt.backend.model.User;
import com.tmdt.backend.repository.RefreshTokenRepository;
...
public class AuthREST {
    ...
    public ResponseEntity<?> signup(@Valid @RequestBody SignupDTO dto) {
        User user = new User(dto.getUsername(), dto.getEmail(), passwordEncoder.encode(dto.getPassword()), dto.getGender());
